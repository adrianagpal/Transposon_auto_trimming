...
def create_dataset(input_fasta, teaid_dir, output_dir, TE_size=15000):
    ...
    np.save(output_dir + "/features_data.npy", feature_data)
    np.save(output_dir + "/labels_data.npy", labels)
